...
public class RadioPlayerService extends Service implements PlayerCallback {
    ...
    private void buildNotification() {
        ...
        intentOpenPlayer.setComponent(new ComponentName("ru.guu.radiog", "ru.guu.radiog.ui.SplashActivity"));
        intentOpenPlayer.setAction(Intent.ACTION_MAIN);
        intentOpenPlayer.addCategory(Intent.CATEGORY_LAUNCHER);
        intentOpenPlayer.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        PendingIntent openPending = PendingIntent.getBroadcast(this, 0, intentOpenPlayer, 0);
